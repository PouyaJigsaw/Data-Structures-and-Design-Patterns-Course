...
public class Board : MonoBehaviour
{
    ...
    public void CreateNewBoard()
    {
        ...
        int binsCount = Random.Range(GameConstants.MinBins , GameConstants.MaxBins + 1);
        float binX = transform.position.x - (binsCount - 1) * binWidth / 2;
        ...
        for (int i = 0; i < binsCount; i++)
        {
            binContents.Add(Random.Range(1, GameConstants.MaxBearsPerBin));
        }
